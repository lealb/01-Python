...
from captcha.cfg import data_root
from captcha.img_tools import get_clear_bin_image, get_crop_imgs
from svmutil import svm_predict, svm_load_model
from captcha.svm_features import get_feature, convert_feature_to_vector
