...
def _get_captcha(content):
    """ 验证码获取函数，返回两个参数 :param content: 登录页面的html代码 :return: 验证码id, 验证码图片的url """
...
class DoubanClient(object):
    ...
    def login(self, username, password, source='index_nav', redir='https://www.douban.com/', remember='on', login='登录'):
        """
        :param username: 用户名
        :param password: 密码
        :param source: 以下参数都是定死的字符串，抓包的时候查看 :
        param redir: :param remember: :param login:
        """
